...
class PostProcViewsTestCase(StaticLiveServerTestCase):
    ...
    def test_postproc_views_absoluta(self):
        ...
        self.driver.find_element(By.ID, "id_username").send_keys("maria")
        self.driver.find_element(By.ID, "id_password").click()
        self.driver.find_element(By.ID, "id_password").send_keys("egcegcegc", Keys.ENTER)
        ...
        self.driver.find_element(By.ID, "id_slug").send_keys("egc")
        ...
        # self.driver.get(f'{self.live_server_url}/admin/store/vote/add/')
        # self.driver.find_element(By.ID, "id_voting_id").send_keys("1")
        # self.driver.find_element(By.ID, "id_voter_id").send_keys("1")
        # self.driver.find_element(By.ID, "id_a").click()
        # self.driver.find_element(By.ID, "id_a").send_keys("81230656238193342219467582177192609949975551104474103274357461751167276833495")
        # self.driver.find_element(By.ID, "id_b").click()
        # self.driver.find_element(By.ID, "id_b").send_keys("29689105100186568648206991662049145977025644855469856673797435671119293212679")
        # self.driver.find_element(By.NAME, "_save").click()
        # time.sleep(5)
        ...
        self.driver.find_element(By.ID, "id_password").click()
        self.driver.find_element(By.ID, "id_password").send_keys("egcegcegc")
        ...
        assert self.driver.find_element(By.CSS_SELECTOR, ".field-postproc .readonly").text == "-"
    ...
    #     self.driver.get(f'{self.live_server_url}/admin/voting/voting/1/change/')
    #     assert self.driver.find_element(By.CSS_SELECTOR, ".field-postproc label").text == "Postproc:"
    #     assert self.driver.find_element(By.CSS_SELECTOR, ".field-tally .readonly").text == "2, 2, 1"
